...
<form id="form1" name="form1" method="get" onsubmit="return validar()" action="sistemenus.php">
  <table width="379" height="109" border="1" align="center" cellspacing="0" bordercolor="#000000">
    <tr>
      <th height="21" colspan="2" bgcolor="#FFFFFF" scope="row"><div align="center" class="Estilo1">Seleccione una Red </div></th>
    </tr>
    <tr>
      <th width="122" height="30" bgcolor="#FFFFFF" scope="row"><div align="left" class="Estilo1">Redes</div></th>
      <td width="247" bgcolor="#FFFFFF"><span class="Estilo1">
...
?>
  ...
  <input type="hidden" name="valor" value="lpr" />
