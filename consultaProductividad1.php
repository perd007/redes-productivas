...
<body>
<p align="center"><span class="Estilo5 Estilo2">Consulta de Productividad  </span></p>
<form id="form1" name="form1" method="get" onsubmit="return pepote(this)" action="sistemenus.php">
  <table width="379" height="129" border="0" align="center" cellspacing="0">
    <tr>
...
?>
    ...
    <tr>
      <th height="22" bgcolor="#FF0000" scope="row">&nbsp;</th>
      <td bgcolor="#FF0000">&nbsp;</td>
    </tr>
  </table>
  <input type="hidden" name="MM_insert" value="form1" />
    <input type="hidden" name="valor" value="cpv1" />
