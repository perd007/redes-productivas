...
$query_productores = "SELECT * FROM productores where id_red='$red'";
...
if($tipo=="productores" and $totalRows_productores==0){
echo "<script type=\"text/javascript\">alert ('No existen Productores Registrados para esta Red'); location.href='sistemenus.php' </script>";
 exit;
}
...
if($tipo=="coopertivas" and $totalRows_cooperativas==0){
echo "<script type=\"text/javascript\">alert ('No existen Cooperativas Registradas para esta Red'); location.href='sistemenus.php' </script>";
 exit;
}
...
<body>
<p align="center"><span class="Estilo5 Estilo2"><strong>Consulta de Productividad </strong></span></p>
...
?>
  ...
  <input type="hidden" name="red" value="<?php echo $red; ?>" />
    <input type="hidden" name="valor" value="cpv2" />
