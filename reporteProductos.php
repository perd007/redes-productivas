...
// Para realizar esto utilizaremos la funcion Row()
	...
	$pdf->SetWidths(array(25,35,30,15,13, 18,22,20)); // Definimos el tamaño de las columnas, tomando en cuenta que las declaramos en milimetros, ya que nuestra hoja esta en milimetro15s
