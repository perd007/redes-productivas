...
echo"<script type=\"text/javascript\">alert ('No Existen Productores Registrados'); location.href='sistemenu.php?valor=p1&link=link2' </script>";
exit;
}
...
<body>
<p align="center" class="Estilo5 Estilo2">Consulta de Productores </p>
<table width="853" border="0" align="center" cellspacing="0">
  <tr bgcolor="#FF0000">
    <th width="154" scope="col">Cedula</th>
    <th width="163" scope="col"><span class="Estilo1">Nombre </span></th>
    <th width="163" scope="col"><span class="Estilo1">Apellido</span></th>
    <th width="181" scope="col"><span class="Estilo1">Red</span></th>
    <th width="58" scope="col"><span class="Estilo1">Opcion</span></th>
...
mysql_select_db($database_conexion, $conexion);
$query_redes = "SELECT * FROM redes where id=$row_productores[id_red]";;
...
$totalRows_redes = mysql_num_rows($redes);
  ...
  <tr bgcolor="<?php echo $color; ?>">
    ...
    <td><div align="center" class="Estilo1"><? echo "<a href='sistemenus.php?cedula=$row_productores[cedula]&valor=mpr&link=link2'>Modificar</a>" ?></div></td>
    <td><div align="center" class="Estilo1"><? echo "<a onClick='return validar()' href='sistemenus.php?cedula=$row_productores[cedula]&valor=epr&link=link2&consu=1'>Eliminar</a>" ?></div></td>
