...
<body>
<p align="center"><span class="Estilo2">Consultar Listados de Cursos </span></p>
...
do {  echo "   <option value='$row_productores[cedula]'"; if (!(strcmp($row_productores['cedula'], $row_productores['nombre']))) {echo "selected=\"selected\"";} echo ">".$row_productores['nombre']."</option>."; ?>
        <?php
...
?>
  ...
  <p>&nbsp;</p>
   <input type="hidden" name="valor" value="clc2" />
